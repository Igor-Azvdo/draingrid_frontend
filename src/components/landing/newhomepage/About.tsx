  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start gap-10 lg:gap-14">
          {/* Photo — smaller, floats alongside text */}
          <div className="w-full max-w-[440px] mx-auto md:mx-0 md:w-[440px] shrink-0 md:sticky md:top-28">
